  ...
  return (
    <section className="flex my-10 items-center justify-center gap-10 flex-col">
      <BlurFade delay={0.25} inView>
        <h2 className="text-5xl font-semibold uppercase text-primary-green">Projects</h2>
      </BlurFade>
      <div className="grid lg:grid-cols-2 gap-10 lg:gap-4 mb-20">
        {projectList.map((project, index) => (
          <BlurFade key={project.title} delay={0.25 + index * 0.15} inView>
            <article className="border rounded-md duration-200 hover:shadow-lg hover:shadow-primary-green p-4 group w-[300px] h-full">
